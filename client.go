...
// interacting with the luminary API. You should not instantiate this client
// directly, and instead use the [NewClient] method instead.
type Client struct {
	Options           []option.RequestOption
	DocumentSummaries DocumentSummaryService
...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("CLIENT_SECRET"); ok {
...
func NewClient(opts ...option.RequestOption) (r Client) {
	...
	r.DocumentSummaries = NewDocumentSummaryService(opts...)
