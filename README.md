...
<a href="https://pkg.go.dev/github.com/withluminary/go-sdk"><img src="https://pkg.go.dev/badge/github.com/withluminary/go-sdk.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/withluminary/go-sdk" // imported as withluminary
)
```
...
```sh
go get -u 'github.com/withluminary/go-sdk@v0.8.0'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/withluminary/go-sdk/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/withluminary/go-sdk/issues) with questions, bugs, or suggestions.
