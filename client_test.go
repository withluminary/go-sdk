...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Households.List(context.Background(), withluminary.HouseholdListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Households.List(cancelCtx, withluminary.HouseholdListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Households.List(deadlineCtx, withluminary.HouseholdListParams{})
		if err == nil {
